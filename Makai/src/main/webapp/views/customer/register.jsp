...
<form:form action="${RequestURI}" modelAttribute="customerForm" enctype="multipart/form-data">
	...
	<div class="col-md-5">
			...
			<acme:password image="lock1" code="customer.password" path="password" mandatory="true" infoButton="true" info="true" id="password"/>
			<acme:password image="lock1" code="customer.repeatPassword" path="repeatPassword" mandatory="true" id="confirm_password"/>
	</div>
