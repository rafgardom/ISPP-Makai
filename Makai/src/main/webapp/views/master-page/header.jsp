...
<div>
	<ul id="jMenu">
		...
		<li><a class="fNiv"><spring:message	code="master.page.vehicle" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="vehicle/register.do"><spring:message code="master.page.vehicle.register" /></a></li>
					<li><a href="vehicle/list.do"><spring:message code="master.page.vehicle.list" /></a></li>					
				</ul>
			</li>
		</security:authorize>
